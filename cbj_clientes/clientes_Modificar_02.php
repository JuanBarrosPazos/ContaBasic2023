...
function process_form(){
	...
	$vname = "`".$vname."`";
	global $ingresos;
	$ingresos = "cbj_ingresos_".date('Y');
	$ingresos = "`".$ingresos."`";
	global $ingresos2;
	$ingresos2 = "cbj_ingresos_".(date('Y')-1);
	$ingresos2 = "`".$ingresos2."`";
	global $ingresos3;
	$ingresos3 = "cbj_ingresos_".(date('Y')-2);
	$ingresos3 = "`".$ingresos3."`";
	global $ingresos4;
	$ingresos4 = "cbj_ingresos_".(date('Y')-3);
	$ingresos4 = "`".$ingresos4."`";
	global $ingresos5;
	$ingresos5 = "cbj_ingresos_".(date('Y')-4);
	$ingresos5 = "`".$ingresos5."`";
	global $ingresos6;
	$ingresos6 = "cbj_ingresos_pendientes";
	$ingresos6 = "`".$ingresos6."`";
