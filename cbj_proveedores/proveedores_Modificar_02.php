...
function process_form(){
	...
	$vname = "`".$vname."`";
	global $gastos;
	$gastos = "cbj_gastos_".date('Y');
	$gastos = "`".$gastos."`";
	global $gastos2;
	$gastos2 = "cbj_gastos_".(date('Y')-1);
	$gastos2 = "`".$gastos2."`";
	global $gastos3;
	$gastos3 = "cbj_gastos_".(date('Y')-2);
	$gastos3 = "`".$gastos3."`";
	global $gastos4;
	$gastos4 = "cbj_gastos_".(date('Y')-3);
	$gastos4 = "`".$gastos4."`";
	global $gastos5;
	$gastos5 = "cbj_gastos_".(date('Y')-4);
	$gastos5 = "`".$gastos5."`";
	global $gastos6;
	$gastos6 = "cbj_gastos_pendientes";
	$gastos6 = "`".$gastos6."`";
