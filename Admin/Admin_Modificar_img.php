...
function process_form(){
	...
	$destination_file = '../cbj_Docs/img_admin/'.$safe_filename;
	

	if( file_exists( '../cbj_Docs/img_admin/'.$safe_filename) ){
		unlink('../cbj_Docs/img_admin/'.$safe_filename);
			}
	elseif (move_uploaded_file($_FILES['myimg']['tmp_name'], $destination_file)){
		
	if( file_exists( '../cbj_Docs/img_admin/'.$_SESSION['smyimg']) ){
			unlink('../cbj_Docs/img_admin/'.$_SESSION['smyimg']);
		}else{}
		...
		$rename_filename = "../cbj_Docs/img_admin/".$new_name;	
	...
	<img src='../cbj_Docs/img_admin/".$_SESSION['new_name']."' height='120px' width='90px' />
					</td>
				</tr>
...
function show_form($errors=''){
	...
	print("<table align='center'  border=0 style='margin-top:20px; width:95.5%'>
				...
				LA IMAGEN ACTUAL DE : </br>".$defaults['Nombre']." ".$defaults['Apellidos'].".
					...
					<th class='BorderInf'>
<img src='../cbj_Docs/img_admin/".$_SESSION['smyimg']."' height='120px' width='90px' />
					</th>
				</tr>
