...
function show_form(){
	...
	$ctemp = "../cbj_Docs/temp";
	global $imgorg;
	$imgorg = "../cbj_Docs/img_admin/".$_POST['myimg'];
...
<img src='../cbj_Docs/img_admin/".$_POST['myimg']."' height='120px' width='90px' />
...
function deletedir(){
	...
	unlink("../cbj_Docs/img_admin/".$_POST['myimg']);
	
	global $refnorm;
	$refnorm = $_SESSION['iniref'];

	$_SESSION['tablas'] = $_POST['ref'];
	global $ruta;
	$ruta ="../cbj_Docs/log/";
	//print("RUTA: ".$ruta.".</br>");
	global $rutag;
