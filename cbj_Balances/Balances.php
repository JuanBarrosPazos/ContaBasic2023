...
elseif($_POST['dm'] != "TRI0"){	global $sent;
	...
	$vname2 = "cbj_status";
	$vname2 = "`".$vname2."`";
	$sqli =  "SELECT * FROM $vnamei INNER JOIN $vname2
			ON $vnamei.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamei.`year` LIKE '%$dyt1%' AND $vnamei.`mes` $sent ORDER BY $vnamei.$orden ";
...
<form name='ver' action='Gastos_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=440px,height=670px')\">
	...
	$sqlb =  "SELECT * FROM $vnameg INNER JOIN $vname2
			ON $vnameg.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnameg.`year` LIKE '%$dyt1%' AND $vnameg.`mes` $sent ORDER BY $vnameg.$orden ";
...
<form name='ver' action='Gastos_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=440px,height=670px')\">
	...
	$sqld =  "SELECT * FROM $vnamed INNER JOIN $vname2
			ON $vnamed.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamed.`year` LIKE '%$dyt1%' AND $vnamed.`mes` $sent ORDER BY $vnamed.$orden ";
...
////////////
	...
	global $nombre;
	$nombre = $_SESSION['gtime'];

	global $ruta;
	$ruta = "../cbj_Docs/grafics/";
	
	$vnameii = "cbj_balancei";
	$vnameii = "`".$vnameii."`";

	$sqli =  "SELECT * FROM $vnameii INNER JOIN $vname2
			ON $vnameii.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnameii.`year` LIKE '%$dyt1%' AND $vnameii.`mes` $sent ORDER BY $vnameii.$orden ";
...
///////////////////////////////////////
	...
	$vnamegg = "cbj_balanceg";
	$vnamegg = "`".$vnamegg."`";

	$sqlg =  "SELECT * FROM $vnamegg INNER JOIN $vname2
			ON $vnamegg.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamegg.`year` LIKE '%$dyt1%' AND $vnamegg.`mes` $sent ORDER BY $vnamegg.$orden ";
...
///////////////////////////////////////
	...
	$vnamedd = "cbj_balanced";
	$vnamedd = "`".$vnamedd."`";

	$sqld =  "SELECT * FROM $vnamedd INNER JOIN $vname2
			ON $vnamedd.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamedd.`year` LIKE '%$dyt1%' AND $vnamedd.`mes` $sent ORDER BY $vnamedd.$orden ";
...
///////////////////////////////////////
	...
	$sqlm =  "SELECT * FROM $vnamegg INNER JOIN $vname2
			ON $vnamegg.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamegg.`year` LIKE '%$dyt1%' AND $vnamegg.`mes` $sent ORDER BY $vnamegg.$orden ";
...
/**/
	$sqly =  "SELECT * FROM $vnamegg INNER JOIN $vname2
			ON $vnamegg.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamegg.`mes` = 'ANU' ORDER BY $vnamegg.$orden ";
...
*/
	...
	$sqly2 =  "SELECT * FROM $vnamegg INNER JOIN $vname2
			ON $vnamegg.`year` = $vname2.`year`
			WHERE 
			$vname2.`hidden` = 'no' AND
			$vnamegg.`year` LIKE '%$dyt1%' AND $vnamegg.`mes` $sent ORDER BY $vnamegg.$orden ";
...
/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function master_index(){
				...
				require '../Inclu_MInd/Master_Index_Balances.php';
