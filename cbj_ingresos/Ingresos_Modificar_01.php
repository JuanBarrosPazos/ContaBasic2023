...
/////////////////////////
	...
	<form name='modifica' action='Ingresos_Modificar_02.php' method='POST'>
...
<form name='ver' action='Ingresos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=682px')\">
...
function show_form($errors=''){
	...
	print("
			...
			<form name='form_tabla' method='post' action='$_SERVER[PHP_SELF]'>
				...
				<tr>
					<td class='BorderSup' align='right'>
...
/////////////////////////
	...
	<input name='coment' type='hidden' value='".$rowb['coment']."' />".$rowb['coment']."
					...
					<input name='myimg4' type='hidden' value='".$rowb['myimg4']."' />
						...
						<td align='center' class='BorderInf'>			
<form name='modifica' action='Ingresos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=682px')\">
...
function info(){
	...
	global $text;
	$text = "\n- INGRESOS MODIFICAR CONSULTAR ".$ActionTime.$filtro;
