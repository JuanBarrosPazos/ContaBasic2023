...
/////////////////////////
	...
	<input name='coment' type='hidden' value='".$rowc['coment']."' />".$rowc['coment']."
				...
				<div align='center' style='float:left'>			
					...
					<div align='center' style='float:left'>			
<form name='modifica' action='Ingresos_Pendientes_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=682px')\">
...
function info(){
	...
	global $text;
	$text = "\n- INGRESOS PENDIENTES MODIFICAR CONSULTAR ".$ActionTime.$filtro;
