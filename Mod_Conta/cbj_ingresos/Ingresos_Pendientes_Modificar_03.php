...
function process_form_2(){
	...
	$tabla = "<table align='center' style='margin-top:10px' width='700px'>
		...
		global $rutaold;
		global $rutanew;
		$rutaold = "../cbj_Docs/docingresos_pendientes/";
...
////////////////////				////////////////////				////////////////////
	...
	if ($errors){
		...
		$dm = array ('' => 'MONTH', '01' => 'ENERO', '02' => 'FEBRERO', '03' => 'MARZO',
		...
		print("<table align='center' style=\"margin-top:10px\">
				<tr>
					<th colspan=2 class='BorderInf'>
								MARCAR COMO COBRADO INGRESO PENDIENTE					
					</th>
				</tr>
				<tr>
					<td>REF. CLIENTE</td>
	...
	if($_POST['proveedores'] != '') {
		...
		<input type='hidden' name='factiva' value='".$defaults['factiva']."' />".$defaults['factiva']." %
				...
				<tr>
					<td>IMPUESTOS €</td>
					<td>
	<input type='hidden' name='factivae1' value='".$defaults['factivae1']."' />".$defaults['factivae1'].",<input type='hidden' name='factivae2' value='".$defaults['factivae2']."' />".$defaults['factivae2']."€
					</td>
				</tr>
				<tr>
					<td>RETENCIONES %</td>
		...
		<input type='hidden' name='factret' value='".$defaults['factret']."' />".$defaults['factret']." %
				...
				<tr>
					<td>RETENCIONES €</td>
					<td>
	<input type='hidden' name='factrete1' value='".$defaults['factrete1']."' />".$defaults['factrete1'].",<input type='hidden' name='factrete2' value='".$defaults['factrete2']."' />".$defaults['factrete2']."€
					</td>
				</tr>
				<tr>
					<td>SUBTOTAL €</td>
					<td>
	<input type='hidden' name='factpvp1' value='".$defaults['factpvp1']."' />".$defaults['factpvp1'].",<input type='hidden' name='factpvp2' value='".$defaults['factpvp2']."' />".$defaults['factpvp2']."€
					</td>
				</tr>
				<tr>
					<td>TOTAL €</td>
					<td>
	<input type='hidden' name='factpvptot1' value='".$defaults['factpvptot1']."' />".$defaults['factpvptot1'].",<input type='hidden' name='factpvptot2' value='".$defaults['factpvptot2']."' />".$defaults['factpvptot2']."€
					</td>
				</tr>
				<tr>
					<td>DESCRIPCIÓN</td>
	...
	<input type='hidden' name='coment' id='coment' value='".$defaults['coment']."'>".$defaults['coment']."
				...
				<tr>
					<td colspan='2' align='right' valign='middle'  class='BorderSup'>
						<input type='submit' value='COBRAR INGRESO PENDIENTE' />
