...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	global $dyx; 		$dyx = "20".$_SESSION['yold'];
	global $dmx; 		$dmx = "M".$_SESSION['mold'];
/*
	if(($dmx != 10)||($dmx != 11)||($dmx != 12)){
	$dmx = substr($_POST['dm'],-1);
		}
...
function show_form($errors=[]){
	...
	if(isset($_POST['oculto2'])){
		...
		$_POST['proveeingresos'] = $_POST['refprovee'];
		
				$defaults = array ( 'id' => $_POST['id'],
									'proveeingresos' => $_POST['refprovee'],
				...
				$defaults = array (	'id' => $_SESSION['idx'],
									'proveeingresos' => $_POST['proveeingresos'],
								   	'refprovee' => $_POST['refprovee'],
									'dy' => $_POST['dy'],
									'dm' => $_POST['dm'],
									'dd' => $_POST['dd'],
