...
////////////////////				////////////////////				////////////////////
	...
	/*	
	$sqlc =  "SELECT * FROM $vname WHERE (`factnum` = '$fnum' OR `factnif` = '$fnif' OR `refcliente` = '$fnom') AND  (`factdate` LIKE '$fil') ORDER BY $orden ";
	*/
	//echo $sqlc;
...
/////////////////////////
	...
	if(!$qc){
		...
		if(mysqli_num_rows($qc) == 0){
			...
			<a href='Ingresos_Crear.php' class='botonverde' style='color:#343434 !important;'>
				CREAR NUEVO INGRESO
			</a>
			<a href='Ingresos_Pendientes_Ver.php' class='botonverde' style='color:#343434 !important;'>
			...
			<a href='Ingresos_Crear.php' class='botonverde' style='color:#343434 !important;'>CREAR NUEVO INGRESO</a>
			<a href='Ingresos_Pendientes_Ver.php' class='botonverde' style='color:#343434 !important;'>VER INGRESOS PENDIENTES</a>
						</th>
					</tr>");
		...
		while($rowb = mysqli_fetch_assoc($qc)){
			...
			require 'Ingresos_rowb_Total.php';
