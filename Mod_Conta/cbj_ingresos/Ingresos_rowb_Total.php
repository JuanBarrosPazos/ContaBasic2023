<?php
    ...
    <form name='ver' action='Ingresos_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=580px,height=660px')\">
        ...
        <input name='coment' type='hidden' value='".$rowb['coment']."' />
            ...
            <input type='hidden' name='oculto2' value=1 />
                ...
                <td class='BorderInf'>			
    <form name='ver' action='Ingresos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=580px,height=600px')\">
    ...
    <form name='modifica' action='Ingresos_Modificar_02.php' method='POST'>
        ...
        <input name='myimg4' type='hidden' value='".$rowb['myimg4']."' />
            ...
            <input type='hidden' name='oculto2' value=1 />
    			...
    			<td class='BorderInf'>
	<form name='modifica' action='Ingresos_Borrar_02.php' method='POST'>
        <input name='dyt1' type='hidden' value='".$dyt1."' />
        <input name='refcliente' type='hidden' value='".$rowb['refcliente']."' />
        <input name='id' type='hidden' value='".$rowb['id']."' />
        <input name='factnum' type='hidden' value='".$rowb['factnum']."' />
