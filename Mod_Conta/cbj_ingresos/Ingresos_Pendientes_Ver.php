...
/////////////////////////
	...
	if(!$qc){
		...
		if(mysqli_num_rows($qc) == 0){
			...
			<a href='Ingresos_Pendientes_Crear.php' class='botonverde' style='color:#343434 !important;'>
				CREAR NUEVO INGRESO PENDIENTE
			</a>
			<a href='Ingresos_Ver.php' class='botonverde' style='color:#343434 !important;'>
				VER INGRESOS
			</a>
						</th>
					</tr>");
		...
		while($rowb = mysqli_fetch_assoc($qc)){
			...
			require 'Ingresos_Pendientes_rowb_Total.php';
