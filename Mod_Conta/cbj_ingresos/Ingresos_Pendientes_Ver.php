...
<form name='ver' action='Ingresos_Pendientes_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=480px,height=670px')\">
...
function show_form($errors=[]){
	...
	if(isset($_POST['show_formcl'])){
				...
				$defaults = array ('factnom' => $_POST['factnom'],
	...
	} else { $defaults = array ('factnom' => $_POST['factnom'],
								'factnif' => $_POST['factnif'],
								'factnum' => $_POST['factnum'],
								'dy' => $_POST['dy'],
								'dm' => $_POST['dm'],
	...
	print("
			...
			<form name='show_formcl' method='post' action='$_SERVER[PHP_SELF]'>
	...
	print ("	<form name='todo' method='post' action='$_SERVER[PHP_SELF]' >
		...
		<input type='hidden' name='factnum' value='".$defaults['factnum']."' />
...
function info(){
	...
	global $text;
	$text = "\n- INGRESOS PENDIENTES CONSULTAR ".$ActionTime.$filtro;
