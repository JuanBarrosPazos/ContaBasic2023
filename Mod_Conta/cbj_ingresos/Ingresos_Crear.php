...
function process_form(){
	...
	if($_FILES['myimg1']['size'] == 0){$new_name1 = 'untitled.png';
			...
			$rename_filename1 = "../cbj_Docs/docingresos_".$dyt1."/".$new_name1;								
			copy("../cbj_Docs/docingresos_".$dyt1."/untitled.png", $rename_filename1);
			}
		else{
			...
			$destination_file1 = "../cbj_Docs/docingresos_".$dyt1."/".$safe_filename1;
		
	    if( file_exists("../cbj_Docs/docingresos_".$dyt1."/".$nombre1) ){
				unlink("../cbj_Docs/docingresos_".$dyt1."/".$nombre1);
	...
	if($_FILES['myimg2']['size'] == 0){$new_name2 = 'untitled.png';
			...
			$rename_filename2 = "../cbj_Docs/docingresos_".$dyt1."/".$new_name2;								
			copy("../cbj_Docs/docingresos_".$dyt1."/untitled.png", $rename_filename2);
			}
		else{
			...
			$destination_file2 = "../cbj_Docs/docingresos_".$dyt1."/".$safe_filename2;
		
	    if( file_exists("../cbj_Docs/docingresos_".$dyt1."/".$nombre2) ){
				unlink("../cbj_Docs/docingresos_".$dyt1."/".$nombre2);
			//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
			}
	...
	if($_FILES['myimg3']['size'] == 0){$new_name3 = 'untitled.png';
			...
			$rename_filename3 = "../cbj_Docs/docingresos_".$dyt1."/".$new_name3;								
			copy("../cbj_Docs/docingresos_".$dyt1."/untitled.png", $rename_filename3);
			}
		else{
			...
			$destination_file3 = "../cbj_Docs/docingresos_".$dyt1."/".$safe_filename3;
		
	    if( file_exists("../cbj_Docs/docingresos_".$dyt1."/".$nombre3) ){
				unlink("../cbj_Docs/docingresos_".$dyt1."/".$nombre3);
			//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
			}
	...
	if($_FILES['myimg4']['size'] == 0){$new_name4 = 'untitled.png';
			...
			$rename_filename4 = "../cbj_Docs/docingresos_".$dyt1."/".$new_name4;								
			copy("../cbj_Docs/docingresos_".$dyt1."/untitled.png", $rename_filename4);
			}
		else{
			...
			$destination_file4 = "../cbj_Docs/docingresos_".$dyt1."/".$safe_filename4;
		
	    if( file_exists("../cbj_Docs/docingresos_".$dyt1."/".$nombre4) ){
				unlink("../cbj_Docs/docingresos_".$dyt1."/".$nombre4);
			//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
			}
