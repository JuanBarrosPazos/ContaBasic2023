		...
		print("<table class='tableForm'>
			...
			<img src='../cbj_Docs/img_proveedores/".$dudas."' height='120px' width='90px' />
				...
				<tr>
					...
					<button type='submit' title='CREAR NUEVO PROVEEDOR' class='botonverde imgDelete PersonAddBlack' style='margin-right:1.2em;'>
...
function show_form($errors=[]){
	...
	<input type='text' name='Direccion' size=42 maxlength=60 placeholder='MI DIRECCION' value='".$defaults['Direccion']."' required />
		...
		<input type='file' name='myimg' value='".@$defaults['myimg']."' style='color:#fff;' />						
				...
				<button title='VER TODOS LOS PROVEEDORES' class='botonverde imgDelete PersonsBlack' style='vertical-align:top;' >
						<a href='proveedores_Ver.php' style='margin-top: -1.8em !important;' >&nbsp;&nbsp;&nbsp;</a>
					</button>
					</td>
				</tr>
			</table>"); /* Fin del print */
