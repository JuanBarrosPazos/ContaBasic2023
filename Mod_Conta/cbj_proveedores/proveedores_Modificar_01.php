		...
		if(!$qc){
			...
			if(mysqli_num_rows($qc)== 0){
				...
				print ("<table align='center'>
						<tr>
							<th colspan=8 class='BorderInf'>PROVEEDORES ".(mysqli_num_rows($qc)-1)."</th>
						</tr>
						<tr>
		...
		print("<font color='#FF0000'>Se ha producido un error: </font></br>".mysqli_error($db)."</br>");
			...
			if(mysqli_num_rows($qb)<= 1){
					print ("<table align='center'>
							...
							<tr>
								<th colspan=8 class='BorderInf'>PROVEEDORES ".(mysqli_num_rows($qb)-1)."</th>
							</tr>
							<tr>
								<th class='BorderInfDch'>ID</th>
								<th class='BorderInfDch'>REFERENCIA</th>
								<th class='BorderInfDch'>DNI</th>
								<th class='BorderInfDch'>RAZON SOCIAL</th>
								<th colspan='4' class='BorderInf'></th>
							</tr>");
