...
<form name='ver' action='Gastos_Pendientes_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=480px,height=670px')\">
...
function info(){
	...
	global $text;
	$text = "\n- GASTOS PENDIENTES CONSULTAR ".$ActionTime.$filtro;
