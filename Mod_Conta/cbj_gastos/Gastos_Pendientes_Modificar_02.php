...
////////////////////				////////////////////				////////////////////
	...
	require 'FormSelectProvee.php'; 
		...
		if($_POST['proveegastos'] != ''){
			...
			<a href='Gastos_Pendiente_Crear.php' class='botonazul' style='color:#343434 !important' >CREAR GASTO PENDIENTE</a>
						</td>
					</tr>
				</table>");
		}
...
////////////////////				////////////////////				////////////////////
	...
	function info_02(){
		...
		global $text;
		$text = "\n- GASTO PENDIENTE MODIFICADO ".$ActionTime.".\n\tNº FACTURA: ".$_POST['factnum'].".\n\tDATE FACTURA: ".$factdate.".\n\tRAZON SOCIAL: ".$_POST['factnom'].".\n\tNIF: ".$_POST['factnif'].".\n\tTIPO IVA %: ".$_POST['factiva'].".\n\tIMP €: ".$factivae.".\n\tNETO €: ".$factpvp.".\n\tTOTAL €: ".$factpvptot;
