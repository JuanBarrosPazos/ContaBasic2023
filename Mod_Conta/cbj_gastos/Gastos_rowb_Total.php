<?php
    ...
    print ("<tr align='center' class='".$styleBgc."'>
        <form name='ver' action='Gastos_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=580px,height=660px')\">
                ...
                <td>			
        <form name='ver' action='Gastos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=580px,height=600px')\">
        ...
        <form name='modifica' action='Gastos_Modificar_02.php' method='POST'>
    		...
    		<td>
	<form name='modifica' action='Gastos_Borrar_02.php' method='POST'>
                <input name='dyt1' type='hidden' value='".$dyt1."' />
                <input name='refprovee' type='hidden' value='".$rowb['refprovee']."' />
                <input name='id' type='hidden' value='".$rowb['id']."' />
                <input name='factnum' type='hidden' value='".$rowb['factnum']."' />
