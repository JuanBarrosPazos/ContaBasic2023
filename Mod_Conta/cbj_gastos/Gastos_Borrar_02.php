...
////////////////////				////////////////////				////////////////////
	...
	function process_form(){
		...
		$tabla = "<table align='center' style='margin-top:10px'>
					...
					<tr>
						<tdIMP %</td><td>".$_POST['factiva']."</td>
						<td>IMP €</td><td>".$factivae."</td>
					</tr>
					<tr>
						<td>RET %</td><td>".$_POST['factret']."</td>
						<td>RET €</td><td>".$factrete."</td>
					</tr>
					<tr>
