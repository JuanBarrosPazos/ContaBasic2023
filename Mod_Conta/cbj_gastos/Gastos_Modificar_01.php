...
<form name='ver' action='Gastos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=682px')\">
...
/////////////////////////
	...
	<input name='coment' type='hidden' value='".$rowb['coment']."' />".$rowb['coment']."
					...
					<input name='myimg4' type='hidden' value='".$rowb['myimg4']."' />
						...
						<td align='center' class='BorderInf'>			
<form name='modifica' action='Gastos_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=682px')\">
...
function info(){
	...
	global $text;
	$text = "\n- GASTOS MODIFICAR CONSULTAR ".$ActionTime.$filtro;
