...
////////////////////				////////////////////				////////////////////
	...
	function a(){
		...
		global $IMxT3; 			$IMxT3 = $ruta."IMxT3.php";
		...
		if($count < 3){	global $IMxT3; 		$IMxT3 = $ruta."IMxT3.php";
		...
		global $IMxD3; 		$IMxD3 = $ruta."IMxD3.php";
		...
		if($count < 3){	global $IMxD3; 		$IMxD3 = $ruta."IMxD3.php";
