	...
	function process_form(){
		...
		//	print("** ".$_POST['vname']." / ".$_POST['dyt1']);
			...
			print("<table align='center'>
				...
				<tr>
				<td class='img1'>
		<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg1."'  onclick=\"MM_showHideLayers('contenedor','','show','foto1A','','show','foto2A','','hide','foto3A','','hide','foto4A','','hide')\" onload=\"MM_showHideLayers('foto1A','','show','foto2A','','hide','foto3A','','hide','foto4A','','hide')\" /> 
		<a style='font-size:14px' href='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$rowsc['myimg1']."' target='_blank'>
						DOWNLOAD 1
					</a>
				</td>
				<td class='img1'>
		<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg2."' onclick=\"MM_showHideLayers('foto1A','','hide','foto2A','','show','foto3A','','hide','foto4A','','hide')\" /> 
		<a style='font-size:14px' href='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$rowsc['myimg2']."' target='_blank'>
						DOWNLOAD 2
					</a>
				</td>
				<td class='img1'>
		<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg3."' onclick=\"MM_showHideLayers('foto1A','','hide','foto2A','','hide','foto3A','','show','foto4A','','hide')\" /> 
		<a style='font-size:14px' href='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$rowsc['myimg3']."' target='_blank'>
						DOWNLOAD 3
					</a>
				</td>
				<td class='img1'>
		<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg4."' onclick=\"MM_showHideLayers('foto1A','','hide','foto2A','','hide','foto3A','','hide','foto4A','','show')\" /> 
		<a style='font-size:14px' href='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$rowsc['myimg4']."' target='_blank'>
						DOWNLOAD 4
					</a>
				</td>
			</tr>
			<tr>
				<div id='foto1A' class='img2'> 
					<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg1."' /> 
				</div>
				<div id='foto2A' class='img2'> 
					<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg2."' /> 
				</div>
				<div id='foto3A' class='img2'> 
					<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg3."' /> 
				</div>
				<div id='foto4A' class='img2'> 
					<img src='../cb23_Docs/docingresos_".$_POST['dyt1']."/".$myimg4."' /> 
				</div>
			</tr>
			<tr>
