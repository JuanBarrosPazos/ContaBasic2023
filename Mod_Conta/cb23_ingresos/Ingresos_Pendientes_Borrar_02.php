...
////////////////////				////////////////////				////////////////////
	...
	function process_form(){
		...
		global $link2;
		$link2 = "<a href='Ingresos_Pendientes_Crear.php' class='botonazul' style='color:#343434 !important' >CREAR NUEVO INGRESO PENDIENTE</a>";
		...
		if(mysqli_query($db, $sqla)){ print($tabla); 
			...
			$sesionref2 = "docingresos_pendientes";

			if( file_exists("../cb23_Docs/".$sesionref2."/".$_POST['myimg1']) ){
				$destination_file = "../cb23_Docs/".$sesionref2."/".$_POST['myimg1'];
				unlink($destination_file);
				}

			if( file_exists("../cb23_Docs/".$sesionref2."/".$_POST['myimg2']) ){
				$destination_file = "../cb23_Docs/".$sesionref2."/".$_POST['myimg2'];
				unlink($destination_file);
				}

			if( file_exists("../cb23_Docs/".$sesionref2."/".$_POST['myimg3']) ){
				$destination_file = "../cb23_Docs/".$sesionref2."/".$_POST['myimg3'];
				unlink($destination_file);
				}

			if( file_exists("../cb23_Docs/".$sesionref2."/".$_POST['myimg4']) ){
				$destination_file = "../cb23_Docs/".$sesionref2."/".$_POST['myimg4'];
				unlink($destination_file);
				}
