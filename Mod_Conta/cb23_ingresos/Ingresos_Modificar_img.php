...
////////////////////				////////////////////				////////////////////
	...
	function modifica_form(){
		...
		global $ruta;
		$ruta = "../cb23_Docs/docingresos_".$_SESSION['midyt1']."/";
		$_SESSION['ruta'] = $ruta;
...
function process_form(){
	...
	global $ruta; 		$ruta = "../cb23_Docs/docingresos_".$_SESSION['midyt1']."/";
	$_SESSION['ruta'] = $ruta;
	...
	global $vname; 		$vname = "`".$_SESSION['clave']."ingresos_".$_SESSION['midyt1']."`";
		...
		SECCION: ".strtoupper($_SESSION['clave']."ingresos_".$_SESSION['midyt1']).".
							</br> 
