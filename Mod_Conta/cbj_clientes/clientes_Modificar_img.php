...
function process_form(){
	...
	unlink("../cbj_Docs/img_clientes/".$_SESSION['myimgx']);
	...
	global $dniold; 	$dinold = $_SESSION['dniold'];
	$dinold = trim($dinold);
...
<img src='../cbj_Docs/img_clientes/".$new_name."' height='120px' width='90px' />
					</td>
				</tr>
	...
	print("
			<table align='center' border=0 style='margin-top:90px;'>
				...
				LA IMAGEN ACTUAL DE : </br>".$defaults['rsocial']."
					...
					<th class='BorderInf'>
<img src='../cbj_Docs/img_clientes/".$defaults['myimg']."' height='120px' width='90px' />
					</th>
				</tr>
