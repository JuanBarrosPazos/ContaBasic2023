...
elseif (trim($_POST['tabla']) == "feedback" ){
...
if (trim($ngastosp) == "cbj_gastos_pendientes" ){
$campo = 'id,factnum,factdate,refprovee,factnom,factnif,factiva,factivae,factpvp,factpvptot,coment,myimg1,myimg2,myimg3,myimg4';
$texc = '`id`, `factnum`, `factdate`, `refprovee`, `factnom`, `factnif`, `factiva`, `factivae`, `factpvp`, `factpvptot`, `coment`, `myimg1`, `myimg2`, `myimg3`, `myimg4`';
		$id = "`id`";
$c3 = "\n\t  `id` int(4) NOT NULL auto_increment,
...
if (trim($ningresos) == "cbj_ingresos_" ){
$campo = 'id,factnum,factdate,refprovee,factnom,factnif,factiva,factivae,factpvp,factpvptot,coment,myimg1,myimg2,myimg3,myimg4';
$texc = '`id`, `factnum`, `factdate`, `refprovee`, `factnom`, `factnif`, `factiva`, `factivae`, `factpvp`, `factpvptot`, `coment`, `myimg1`, `myimg2`, `myimg3`, `myimg4`';
		$id = "`id`";
$c3 = "\n\t  `id` int(4) NOT NULL auto_increment,
...
if (trim($ningresosp) == "cbj_ingresos_pendientes" ){
$campo = 'id,factnum,factdate,refprovee,factnom,factnif,factiva,factivae,factpvp,factpvptot,coment,myimg1,myimg2,myimg3,myimg4';
$texc = '`id`, `factnum`, `factdate`, `refprovee`, `factnom`, `factnif`, `factiva`, `factivae`, `factpvp`, `factpvptot`, `coment`, `myimg1`, `myimg2`, `myimg3`, `myimg4`';
		$id = "`id`";
$c3 = "\n\t  `id` int(4) NOT NULL auto_increment,
...
if (trim($nproveedores) == "cbj_proveedores" ){
...
if (trim($nclientes) == "cbj_clientes" ){
$campo = 'id,ref,rsocial,myimg,doc,dni,ldni,Email,Direccion,Tlf1,Tlf2';
$texc = '`id`, `ref`, `rsocial`, `myimg`, `doc`, `dni`, `ldni`, `Email`, `Direccion`, `Tlf1`, `Tlf2`';
		$id = "`id`";
$c3 = "\n\t    `id` int(4) NOT NULL auto_increment,
...
// EXPORTA LA TABLA BALANCES G DEL USUARIO //

global $nbalanceg;
$nbalanceg = trim($_POST['tabla']);

if (trim($nbalanceg) == "cbj_balanceg" ){
$campo = 'id,year,mes,iva,sub,tot';
$texc = '`id`, `year`, `mes`, `iva`, `sub`, `tot`';
		$id = "`id`";
...
// EXPORTA LA TABLA BALANCES I DEL USUARIO //

global $nbalancei;
$nbalancei = trim($_POST['tabla']);

if (trim($nbalancei) == "cbj_balancei" ){
$campo = 'id,year,mes,iva,sub,tot';
$texc = '`id`, `year`, `mes`, `iva`, `sub`, `tot`';
		$id = "`id`";
$c3 = "\n\t	`id` int(2) NOT NULL auto_increment,
...
// EXPORTA LA TABLA BALANCES DEL USUARIO //

global $nbalanced;
$nbalanced = trim($_POST['tabla']);

if (trim($nbalanced) == "cbj_balanced" ){
$campo = 'id,year,mes,iva,sub,tot';
$texc = '`id`, `year`, `mes`, `iva`, `sub`, `tot`';
		$id = "`id`";
$c3 = "\n\t	`id` int(2) NOT NULL auto_increment,
